...
public class CalculatorApp implements ActionListener {
    ...
    public void addComponents ()
    {
        ...
        textField.setFont(new Font("Aerial",Font.BOLD,20));
        ...
        offButtonradioButton.setSelected(true);
        ...
        buttonSeven.setBackground(new Color(55,71,79));
        ...
        buttonEight.setBackground(new Color(55,71,79));
        ...
        buttonNine.setBackground(new Color(55,71,79));
        ...
        buttonFour.setBackground(new Color(55,71,79));
        ...
        buttonFive.setBackground(new Color(55,71,79));
        ...
        buttonSix.setBackground(new Color(55,71,79));
        ...
        buttonOne.setBackground(new Color(55,71,79));
        ...
        buttonTwo.setBackground(new Color(55,71,79));
        ...
        buttonThree.setBackground(new Color(55,71,79));

        frame.add(buttonThree);

        buttonDot.setBounds(150,410,60,40);
        buttonDot.setFont(new Font("Arial",Font.BOLD,20));
        buttonDot.setBackground(new Color(55,71,79));
        ...
        buttonZero.setBackground(new Color(55,71,79));
        ...
        buttonEqual.setBackground(new Color(13, 71, 161));
        ...
        buttonDiv.setBackground(new Color(13, 71, 161));
        ...
        buttonSqrt.setBackground(new Color(55,71,79));
        ...
        buttonMul.setBackground(new Color(13, 71, 161));
        ...
        buttonMinus.setBackground(new Color(13, 71, 161));
        ...
        buttonPlus.setBackground(new Color(13, 71, 161));
        ...
        buttonSquare.setBackground(new Color(55,71,79));
        buttonSquare.setFocusable(false);
        buttonSquare.setForeground(Color.white);
        frame.add(buttonSquare);

        buttonexponent.setBounds(150,170,60,40);
        buttonexponent.setFont(new Font("Arial",Font.BOLD,15));
        buttonexponent.setBackground(new Color(55,71,79));
        buttonexponent.setFocusable(false);
        buttonexponent.setForeground(Color.white);
        frame.add(buttonexponent); 

        buttonDelete.setBounds(150,110,60,40);
        buttonDelete.setFont(new Font("Arial",Font.BOLD,12));
        buttonDelete.setBackground(new Color(13, 71, 161));
        ...
        buttonClear.setBackground(new Color(13, 71, 161));
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       Object source = e.getSource();
        ...
        }else if(source==buttonexponent){
            String str = textField.getText();
            num1 = Double.parseDouble(textField.getText());
            calculation=5; // Define exponentiation operation
            textField.setText("");
            label.setText(str +"^");
